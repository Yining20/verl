...
WANDB_EXPERIMENT_NAME=${WANDB_EXPERIMENT_NAME:-qwen3-1.7b-dapo-17k}
...
max_response_length=${MAX_RESP_LEN:-4096}
...
# Overlong buffer (paper: buffer_len=4096 with max_resp=20480, ratio ≈ 1:5)
...
total_training_steps=${TOTAL_STEPS:--1}
